...
open class CalculatorInput(
        ...
        if (newInput.toDoubleOrNull() != null) {
            ...
            if (newInput == "=") {
                if (this.newNumber.isNotEmpty()) {
                    this.myString.add(handleEqual())
                    this.newNumber = handleEqual()
                }
                return handleEqual()
            } else {
                ...
                if (newInput in rightAssociative && this.newNumber.isEmpty() && this.myString.isEmpty()) {
                    myoutput += "1"
                }
    ...
    private fun addStackNumber(operator : String){
        if (this.newNumber.isNotEmpty()) {
            ...
            if (operator in rightAssociative && this.myString.isEmpty()) {
